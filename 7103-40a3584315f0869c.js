    ...
    [7103], {
        84256: function(e, t, n) {
            ...
            let u = async (e, t, n) => {
                let {
                    ...
                    middleware: l = [],
                    platform: i
                } = n, u = l.filter(Boolean), s = await (null == i.isRTL ? void 0 : i.isRTL(t)), c = await i.getElementRects({
                    reference: e,
                    floating: t,
                    strategy: o
                }), {
                ...
                for (let n = 0; n < u.length; n++) {
                    ...
                    }, x && h <= 50 && (h++, "object" == typeof x && (x.placement && (p = x.placement), x.rects && (c = !0 === x.rects ? await i.getElementRects({
                        reference: e,
                        floating: t,
                        strategy: o
                    }) : x.rects), {
            ...
            async function d(e, t) {
                ...
                let {
                    ...
                    altBoundary: m = !1,
                    padding: h = 0
                } = t, v = s(h), g = a[m ? "floating" === p ? "reference" : "floating" : p], y = c(await l.getClippingRect({
                    ...
                    rootBoundary: f,
                    strategy: u
                })), w = "floating" === p ? { ...i.floating,
                    x: r,
                    y: o
                } : i.reference, x = await (null == l.getOffsetParent ? void 0 : l.getOffsetParent(a.floating)), b = await (null == l.isElement ? void 0 : l.isElement(x)) && await (null == l.getScale ? void 0 : l.getScale(x)) || {
                    x: 1,
                    y: 1
                }, E = c(l.convertOffsetParentRelativeRectToViewportRelativeRect ? await l.convertOffsetParentRelativeRectToViewportRelativeRect({
                    rect: w,
                    offsetParent: x,
                    strategy: u
                }) : w);
                ...
                m = e => ({
                    ...
                    async fn(t) {
                        ...
                        let v = s(l),
                            ...
                            R = g[y] - d.reference[y],
                            T = await (null == m.getOffsetParent ? void 0 : m.getOffsetParent(n)),
                            L = T ? T[C] : 0;
                        L && await (null == m.isElement ? void 0 : m.isElement(T)) || (L = h.floating[C] || d.floating[w]);
                        let D = v[E],
                            k = L - x[w] - v[S],
                            A = L / 2 - x[w] / 2 + (P / 2 - R / 2),
                            O = p(D, f(A, k)),
                            M = null != r(c) && A != O && d.reference[w] / 2 - (A < D ? v[E] : v[S]) - x[w] / 2 < 0;
                        return {
                ...
                return void 0 === e && (e = {}), {
                    ...
                    async fn(t) {
                        ...
                        let {
                            ...
                            flipAlignment: C = !0,
                            ...P
                        } = e, R = l(c), T = l(m) === m, L = await (null == h.isRTL ? void 0 : h.isRTL(v.floating)), D = b || (T || !C ? [g(m)] : function(e) {
                            let t = g(e);
                            return [w(e), t, w(t)]
                        }(m));
                        b || "none" === S || D.push(... function(e, t, n, o) {
                            let i = r(e),
                                a = function(e, t, n) {
                                    let r = ["left", "right"],
                                        o = ["right", "left"];
                        ...
                        if (y && O.push(A[R]), x) {
                            let {
                                ...
                                let l = r(e),
                                    a = i(e),
                                    u = o(a),
                                    s = "x" === a ? l === (n ? "end" : "start") ? "right" : "left" : "start" === l ? "bottom" : "top";
                                return t.reference[u] > t.floating[u] && (s = g(s)), {
                                    main: s,
                                    cross: g(s)
                                }
                            }(c, p, L);
                        ...
                        if (M = [...M, {
                            ...
                            let n = null == (u = M.filter(e => e.overflows[0] <= 0).sort((e, t) => e.overflows[1] - t.overflows[1])[0]) ? void 0 : u.placement;
                            if (!n) switch (E) {
                                case "bestFit":
                                    {
                                        let e = null == (s = M.map(e => [e.placement, e.overflows.filter(e => e > 0).reduce((e, t) => e + t, 0)]).sort((e, t) => e[1] - t[1])[0]) ? void 0 : s[0];e && (n = e);
                                        break
                                    }
                        ...
                        async fn(t) {
                            let {
                                ...
                                let {
                                    ...
                                    platform: o,
                                    elements: a
                                } = e, u = await (null == o.isRTL ? void 0 : o.isRTL(a.floating)), s = l(n), c = r(n), d = "x" === i(n), f = ["left", "top"].includes(s) ? -1 : 1, p = u && d ? -1 : 1, m = "function" == typeof t ? t(e) : t, {
                                    mainAxis: h,
                                    crossAxis: v,
                                    alignmentAxis: g
                                } = "number" == typeof m ? {
                    ...
                    return void 0 === e && (e = {}), {
                        ...
                        async fn(t) {
                            let {
                                ...
                                x: n,
                                y: r
                            }, h = await d(t, c), v = i(l(o)), g = P(v), y = m[v], w = m[g];
                    ...
                    return void 0 === e && (e = {}), {
                        ...
                        fn(t) {
                            let {
                                ...
                                x: n,
                                y: r
                            }, p = i(o), m = P(p), h = f[p], v = f[m], g = "function" == typeof s ? s(t) : s, y = "number" == typeof g ? {
                                mainAxis: g,
                                crossAxis: 0
                            } : {
                                mainAxis: 0,
                            ...
                            if (d) {
                                ...
                                let e = "y" === p ? "width" : "height",
                                    ...
                                    r = a.reference[m] + a.reference[e] + (t ? 0 : (null == (x = u.offset) ? void 0 : x[m]) || 0) - (t ? y.crossAxis : 0);
                                v < n ? v = n : v > r && (v = r)
                            }
                            return {
                                [p]: h,
                    ...
                    return void 0 === e && (e = {}), {
                        ...
                        async fn(t) {
                            ...
                            let {
                                ...
                                apply: m = () => {},
                                ...h
                            } = e, v = await d(t, h), g = l(a), y = r(a), w = "x" === i(a), {
                                width: x,
                                height: b
                            } = u.floating;
                            "top" === g || "bottom" === g ? (n = g, o = y === (await (null == s.isRTL ? void 0 : s.isRTL(c.floating)) ? "start" : "end") ? "left" : "right") : (o = g, n = "end" === y ? "top" : "bottom");
                            let E = b - v[n],
                                S = x - v[o],
                            ...
                            if (C && !y) {
                                let e = p(v.left, 0),
                                    ...
                                    n = p(v.top, 0),
                                    r = p(v.bottom, 0);
                                w ? R = x - 2 * (0 !== e || 0 !== t ? e + t : p(v.left, v.right)) : P = b - 2 * (0 !== n || 0 !== r ? n + r : p(v.top, v.bottom))
                            }
                            await m({ ...t,
                                availableWidth: R,
                                availableHeight: P
        ...
        88905: function(e, t, n) {
            ...
            function k(e, t, n) {
                ...
                if ("viewport" === t) i = function(e, t) {
                    ...
                    if (l) {
                        ...
                        let e = p();
                        (!e || e && "fixed" === t) && (u = l.offsetLeft, s = l.offsetTop)
                    }
                    return {
                        width: i,
                        height: a,
                    ...
                    let t = P(e),
                        ...
                        a = -n.scrollLeft + T(e),
                        u = -n.scrollTop;
                    return "rtl" === l(r).direction && (a += v(t.clientWidth, r.clientWidth) - o), {
                        width: o,
                        height: i,
                        x: a,
                        y: u
            ...
            function O(e, t) {
                ...
                if (!u(e)) return n;
                let r = A(e, t);
                for (; r && ["table", "td", "th"].includes(a(r)) && "static" === l(r).position;) r = A(r, t);
            ...
            let M = {
                    ...
                    let {
                        ...
                        for (; s(u) && !m(u);) {
                            ...
                            n || "fixed" !== t.position || (o = null), (i ? !n && !o : !n && "static" === t.position && o && ["absolute", "fixed"].includes(o.position) || d(u) && !n && function e(t, n) {
                                let r = L(t);
                                return !(r === n || !s(r) || m(r)) && ("fixed" === l(r).position || e(r, n))
                            }(e, u)) ? r = r.filter(e => e !== u) : o = t, u = L(u)
                        }
                        return t.set(e, r), r
                    }(t, this._c) : [].concat(n), u = [...i, r], c = u[0], p = u.reduce((e, n) => {
                        let r = k(t, n, o);
                ...
                convertOffsetParentRelativeRectToViewportRelativeRect: function(e) {
                    ...
                    if ((o || !o && "fixed" !== r) && (("body" !== a(n) || d(l)) && (i = R(n)), u(n))) {
                        let e = C(n);
            ...
            function _(e, t, n, r) {
                ...
                let {
                    ...
                    elementResize: i = !0,
                    animationFrame: a = !1
                } = r, u = o || l ? [...s(e) ? D(e) : e.contextElement ? D(e.contextElement) : [], ...D(t)] : [];
                u.forEach(e => {
                ...
                i && (d = new ResizeObserver(() => {
                    n()
                }), s(e) && !a && d.observe(e), s(e) || !e.contextElement || a || d.observe(e.contextElement), d.observe(t));
                let f = a ? C(e) : null;
                return a && function t() {
                    let r = C(e);
                    f && (r.x !== f.x || r.y !== f.y || r.width !== f.width || r.height !== f.height) && n(), f = r, c = requestAnimationFrame(t)
                }(), n(), () => {
                    var e;
                    u.forEach(e => {
                        o && e.removeEventListener("scroll", n), l && e.removeEventListener("resize", n)
                    }), null == (e = d) || e.disconnect(), d = null, a && cancelAnimationFrame(c)
                }
            }
            let W = (e, t, n) => {
                let o = new Map,
        ...
        47103: function(e, t, n) {
            ...
            let g = "dismissableLayer.update",
                ...
                w = (0, i.forwardRef)((e, t) => {
                    ...
                    let {
                        ...
                        onDismiss: f,
                        ...p
                    } = e, w = (0, i.useContext)(y), [E, S] = (0, i.useState)(null), C = null !== (n = null == E ? void 0 : E.ownerDocument) && void 0 !== n ? n : null == globalThis ? void 0 : globalThis.document, [, P] = (0, i.useState)({}), R = (0, d.e)(t, e => S(e)), T = Array.from(w.layers), [L] = [...w.layersWithOutsidePointerEventsDisabled].slice(-1), D = T.indexOf(L), k = E ? T.indexOf(E) : -1, A = w.layersWithOutsidePointerEventsDisabled.size > 0, O = k >= D, M = function(e, t = null == globalThis ? void 0 : globalThis.document) {
                        let n = (0, v.W)(e),
                            r = (0, i.useRef)(!1),
                            o = (0, i.useRef)(() => {});
                        ...
                        !O || n || (null == a || a(e), null == c || c(e), e.defaultPrevented || null == f || f())
                    }, C), _ = function(e, t = null == globalThis ? void 0 : globalThis.document) {
                        let n = (0, v.W)(e),
                            r = (0, i.useRef)(!1);
                        return (0, i.useEffect)(() => {
                            let e = e => {
                        ...
                        let t = e.target,
                            n = [...w.branches].some(e => e.contains(t));
                        n || (null == u || u(e), null == c || c(e), e.defaultPrevented || null == f || f())
                    }, C);
                    return ! function(e, t = null == globalThis ? void 0 : globalThis.document) {
                        ...
                        t && (null == l || l(e), !e.defaultPrevented && f && (e.preventDefault(), f()))
                    }, C), (0, i.useEffect)(() => {
                        if (E) return o && (0 === w.layersWithOutsidePointerEventsDisabled.size && (r = C.body.style.pointerEvents, C.body.style.pointerEvents = "none"), w.layersWithOutsidePointerEventsDisabled.add(E)), w.layers.add(E), x(), () => {
                            o && 1 === w.layersWithOutsidePointerEventsDisabled.size && (C.body.style.pointerEvents = r)
                        }
                    }, [E, C, o, w]), (0, i.useEffect)(() => () => {
                        E && (w.layers.delete(E), w.layersWithOutsidePointerEventsDisabled.delete(E), x())
                    }, [E, w]), (0, i.useEffect)(() => {
                        let e = () => P({});
                        return document.addEventListener(g, e), () => document.removeEventListener(g, e)
                    }, []), (0, i.createElement)(h.WV.div, (0, m.Z)({}, p, {
                        ref: R,
                        style: {
            ...
            let C = "focusScope.autoFocusOnMount",
                ...
                T = (0, i.forwardRef)((e, t) => {
                    let {
                        ...
                        ...a
                    } = e, [u, s] = (0, i.useState)(null), c = (0, v.W)(o), f = (0, v.W)(l), p = (0, i.useRef)(null), g = (0, d.e)(t, e => s(e)), y = (0, i.useRef)({
                        paused: !1,
                        pause() {
                            this.paused = !0
                        },
                    ...
                    (0, i.useEffect)(() => {
                        if (r) {
                            function e(e) {
                                ...
                                let t = e.target;
                                u.contains(t) ? p.current = t : k(p.current, {
                                    select: !0
                                })
                            }
                            ...
                            function t(e) {
                                ...
                                null === t || u.contains(t) || k(p.current, {
                                    select: !0
                                })
                            }
                            ...
                            let n = new MutationObserver(function(e) {
                                ...
                                for (let n of e) n.removedNodes.length > 0 && !(null != u && u.contains(t)) && k(u)
                            });
                        ...
                        if (u) {
                            ...
                            if (!t) {
                                ...
                                u.addEventListener(C, c), u.dispatchEvent(t), t.defaultPrevented || (function(e, {
                                    select: t = !1
                                } = {}) {
                            ...
                            return () => {
                                u.removeEventListener(C, c), setTimeout(() => {
                                    let t = new CustomEvent(P, R);
                                    u.addEventListener(P, f), u.dispatchEvent(t), t.defaultPrevented || k(null != e ? e : document.body, {
                                        select: !0
                                    }), u.removeEventListener(P, f), A.remove(y)
                                }, 0)
                            }
                        }
                    }, [u, c, f, y]);
                    let w = (0, i.useCallback)(e => {
                        ...
                        if (t && o) {
                            ...
                            r && l ? e.shiftKey || o !== l ? e.shiftKey && o === r && (e.preventDefault(), n && k(l, {
                                select: !0
                            })) : (e.preventDefault(), n && k(r, {
                                select: !0
                            })) : o === t && e.preventDefault()
                        }
                    }, [n, r, y.paused]);
                    return (0, i.createElement)(h.WV.div, (0, m.Z)({
                        tabIndex: -1
                    }, a, {
                        ref: g,
                        onKeyDown: w
                ...
                return {
                    ...
                    fn(e) {
                        if (t && ({}).hasOwnProperty.call(t, "current")) {
                            if (null != t.current) return (0, _.x7)({
                                element: t.current,
                                padding: n
                            }).fn(e)
                        } else if (t) return (0, _.x7)({
                            element: t,
                            padding: n
                        }).fn(e);
                        return {}
            ...
            let K = (0, i.forwardRef)((e, t) => {
                ...
                return (0, i.createElement)(h.WV.svg, (0, m.Z)({}, l, {
                    ref: t,
                    width: r,
                    height: o,
                    viewBox: "0 0 30 10",
            ...
            let $ = "Popper",
                ...
                J = (0, i.forwardRef)((e, t) => {
                    let {
                        ...
                        virtualRef: r,
                        ...o
                    } = e, l = Y("PopperAnchor", n), a = (0, i.useRef)(null), u = (0, d.e)(t, a);
                    return (0, i.useEffect)(() => {
                        l.onAnchorChange((null == r ? void 0 : r.current) || a.current)
                    }), r ? null : (0, i.createElement)(h.WV.div, (0, m.Z)({}, o, {
                        ref: u
                    }))
                }),
                G = "PopperContent",
                ...
                et = (0, i.forwardRef)((e, t) => {
                    ...
                    let {
                        ...
                        onPlaced: T,
                        ...L
                    } = e, D = Y(G, p), [k, A] = (0, i.useState)(null), O = (0, d.e)(t, e => A(e)), [M, K] = (0, i.useState)(null), $ = (0, z.t)(M), j = null !== (n = null == $ ? void 0 : $.width) && void 0 !== n ? n : 0, U = null !== (r = null == $ ? void 0 : $.height) && void 0 !== r ? r : 0, q = "number" == typeof S ? S : {
                        top: 0,
                        right: 0,
                        bottom: 0,
                        left: 0,
                        ...S
                    }, X = Array.isArray(E) ? E : [E], J = X.length > 0, ee = {
                        padding: q,
                        boundary: X.filter(er),
                        altBoundary: J
                    }, {
                        refs: et,
                        floatingStyles: en,
                        ...
                        V(m, r) || h(r);
                        let [v, g] = i.useState(null), [y, w] = i.useState(null), x = i.useCallback(e => {
                            e != C.current && (C.current = e, g(e))
                        }, [g]), b = i.useCallback(e => {
                            e !== P.current && (P.current = e, w(e))
                        }, [w]), E = l || v, S = u || y, C = i.useRef(null), P = i.useRef(null), R = i.useRef(f), T = N(c), L = N(o), D = i.useCallback(() => {
                            ...
                            L.current && (e.platform = L.current), (0, W.oo)(C.current, P.current, e).then(e => {
                                let t = { ...e,
                                    isPositioned: !0
                                };
                                k.current && !V(R.current, t) && (R.current = t, a.flushSync(() => {
                                    p(t)
                                }))
                            })
                        }, [m, t, n, L]);
                    ...
                    return (0, Z.b)(() => {
                        ...
                        style: { ...en,
                            ...
                            zIndex: eh,
                            "--radix-popper-transform-origin": [null === (s = eu.transformOrigin) || void 0 === s ? void 0 : s.x, null === (c = eu.transformOrigin) || void 0 === c ? void 0 : c.y].join(" ")
                        },
                        dir: e.dir
                    }, (0, i.createElement)(Q, {
                        scope: p,
                        ...
                        arrowY: ep,
                        shouldHideArrow: em
                    }, (0, i.createElement)(h.WV.div, (0, m.Z)({
                        "data-side": es,
                        "data-align": ec
                    }, L, {
                        ref: O,
                        style: { ...L.style,
                            ...
                            opacity: null !== (f = eu.hide) && void 0 !== f && f.referenceHidden ? 0 : void 0
                        }
                    }))))
                }),
                en = {
            ...
            let eo = e => ({
                ...
                fn(t) {
                    ...
                    let {
                        ...
                        rects: u,
                        middlewareData: s
                    } = t, c = (null === (n = s.arrow) || void 0 === n ? void 0 : n.centerOffset) !== 0, d = c ? 0 : e.arrowWidth, f = c ? 0 : e.arrowHeight, [p, m] = el(a), h = {
                        start: "0%",
                        center: "50%",
                        end: "100%"
                    }[m], v = (null !== (r = null === (o = s.arrow) || void 0 === o ? void 0 : o.x) && void 0 !== r ? r : 0) + d / 2, g = (null !== (l = null === (i = s.arrow) || void 0 === i ? void 0 : i.y) && void 0 !== l ? l : 0) + f / 2, y = "", w = "";
                    return "bottom" === p ? (y = c ? h : `${v}px`, w = `${-f}px`) : "top" === p ? (y = c ? h : `${v}px`, w = `${u.floating.height+f}px`) : "right" === p ? (y = `${-f}px`, w = c ? h : `${g}px`) : "left" === p && (y = `${u.floating.width+f}px`, w = c ? h : `${g}px`), {
                        data: {
                            x: y,
                            y: w
                        }
            ...
            let ei = (0, i.forwardRef)((e, t) => {
                ...
                return r ? a.createPortal((0, i.createElement)(h.WV.div, (0, m.Z)({}, o, {
                    ref: t
                })), r) : null
            });
            var ea = n(26739),
            ...
            let ep = [" ", "Enter", "ArrowUp", "ArrowDown"],
                ...
                eR = e => {
                    let {
                        ...
                        disabled: m,
                        required: h
                    } = e, v = eb(t), [g, y] = (0, i.useState)(null), [w, x] = (0, i.useState)(null), [b, E] = (0, i.useState)(!1), S = (0, p.gm)(c), [C = !1, P] = (0, eu.T)({
                        prop: r,
                        defaultProp: o,
                        onChange: l
                    }), [R, T] = (0, eu.T)({
                        ...
                        defaultProp: u,
                        onChange: s
                    }), L = (0, i.useRef)(null), D = !g || !!g.closest("form"), [k, A] = (0, i.useState)(new Set), O = Array.from(k).map(e => e.props.value).join(";");
                    return (0, i.createElement)(X, v, (0, i.createElement)(eE, {
                        required: h,
                        scope: t,
                        trigger: g,
                        onTriggerChange: y,
                        ...
                        disabled: m
                    }, (0, i.createElement)(ev.Provider, {
                        scope: t
                    }, (0, i.createElement)(eC, {
                        ...
                        disabled: m
                    }, void 0 === R ? (0, i.createElement)("option", {
                        value: ""
                ...
                eT = (0, i.forwardRef)((e, t) => {
                    let {
                        ...
                        disabled: r = !1,
                        ...o
                    } = e, a = eb(n), u = eS("SelectTrigger", n), c = u.disabled || r, f = (0, d.e)(t, u.onTriggerChange), p = eg(n), [m, v, g] = e2(e => {
                    ...
                    return (0, i.createElement)(J, (0, l.Z)({
                        asChild: !0
                    }, a), (0, i.createElement)(h.WV.button, (0, l.Z)({
                        type: "button",
                        role: "combobox",
                        ...
                        onKeyDown: (0, s.M)(o.onKeyDown, e => {
                            ...
                            n || 1 !== e.key.length || v(e.key), (!t || " " !== e.key) && ep.includes(e.key) && (y(), e.preventDefault())
                        })
                    })))
                }),
                eL = (0, i.forwardRef)((e, t) => {
                    let {
                        ...
                        placeholder: u,
                        ...s
                    } = e, c = eS("SelectValue", n), {
                        onValueNodeHasChildrenChange: f
                    } = c, p = void 0 !== a, m = (0, d.e)(t, c.onValueNodeChange);
                    return (0, Z.b)(() => {
                        f(p)
                    }, [f, p]), (0, i.createElement)(h.WV.span, (0, l.Z)({}, s, {
                        ref: m,
                        style: {
                            pointerEvents: "none"
                        }
                ...
                eD = (0, i.forwardRef)((e, t) => {
                    ...
                    return (0, i.createElement)(h.WV.span, (0, l.Z)({
                        "aria-hidden": !0
                    }, o, {
                        ref: t
                    }), r || "▼")
                }),
                ek = e => (0, i.createElement)(ei, (0, l.Z)({
                    asChild: !0
                }, e)),
                eA = "SelectContent",
                eO = (0, i.forwardRef)((e, t) => {
                    ...
                    }, []), n.open) ? (0, i.createElement)(eW, (0, l.Z)({}, e, {
                        ref: t
                    })) : r ? (0, a.createPortal)((0, i.createElement)(eM, {
                        scope: e.__scopeSelect
                    }, (0, i.createElement)(ev.Slot, {
                        scope: e.__scopeSelect
                ...
                eW = (0, i.forwardRef)((e, t) => {
                    let {
                        ...
                        avoidCollisions: b,
                        ...C
                    } = e, P = eS(eA, n), [R, L] = (0, i.useState)(null), [D, k] = (0, i.useState)(null), A = (0, d.e)(t, e => L(e)), [O, M] = (0, i.useState)(null), [_, W] = (0, i.useState)(null), I = eg(n), [H, V] = (0, i.useState)(!1), F = (0, i.useRef)(!1);
                    (0, i.useEffect)(() => {
                        if (R) return (0, ed.Ry)(R)
                    }, [R]), (0, i.useEffect)(() => {
                        var e, t;
                        let n = document.querySelectorAll("[data-radix-focus-guard]");
                        return document.body.insertAdjacentElement("afterbegin", null !== (e = n[0]) && void 0 !== e ? e : S()), document.body.insertAdjacentElement("beforeend", null !== (t = n[1]) && void 0 !== t ? t : S()), E++, () => {
                            ...
                            let e = {
                                ...
                                t = t => {
                                    ...
                                    e = {
                                        ...
                                        y: Math.abs(Math.round(t.pageY) - (null !== (o = null === (l = Z.current) || void 0 === l ? void 0 : l.y) && void 0 !== o ? o : 0))
                                    }
                                },
                                n = n => {
                                    e.x <= 10 && e.y <= 10 ? n.preventDefault() : R.contains(n.target) || K(!1), document.removeEventListener("pointermove", t), Z.current = null
                                };
                    ...
                    }, [P.value]), U = (0, i.useCallback)(() => null == R ? void 0 : R.focus(), [R]), q = (0, i.useCallback)((e, t, n) => {
                        let r = !F.current && !n,
                            o = void 0 !== P.value && P.value === t;
                        (o || r) && W(e)
                    }, [P.value]), Y = "popper" === r ? eH : eI;
                ...
                eI = (0, i.forwardRef)((e, t) => {
                    let {
                        ...
                        onPlaced: r,
                        ...o
                    } = e, a = eS(eA, n), s = e_(eA, n), [c, f] = (0, i.useState)(null), [p, m] = (0, i.useState)(null), v = (0, d.e)(t, e => m(e)), g = eg(n), y = (0, i.useRef)(!1), w = (0, i.useRef)(!0), {
                        viewport: x,
                        selectedItem: b,
                        selectedItemText: E,
                        focusSelectedItem: S
                        ...
                        if (a.trigger && a.valueNode && c && p && x && b && E) {
                            ...
                            if (k <= T) {
                                ...
                                c.style.height = k + Math.max(i - T, L + (e ? R : 0) + t + h) + "px"
                            } else {
                                let e = b === l[0].ref.current;
                                c.style.top = "0px";
                                let t = Math.max(T, f + x.offsetTop + (e ? P : 0) + L);
                                c.style.height = t + (w - k) + "px", x.scrollTop = k - T + x.offsetTop
                            }
                            c.style.margin = "10px 0", c.style.minHeight = S + "px", c.style.maxHeight = i + "px", null == r || r(), requestAnimationFrame(() => y.current = !0)
                        }
                    ...
                    let T = (0, i.useCallback)(e => {
                        e && !0 === w.current && (C(), null == S || S(), w.current = !1)
                    }, [C, S]);
                    return (0, i.createElement)(eV, {
                        scope: n,
                        contentWrapper: c,
                    ...
                    }, (0, i.createElement)(h.WV.div, (0, l.Z)({}, o, {
                        ref: v,
                        style: {
                ...
                eH = (0, i.forwardRef)((e, t) => {
                    ...
                    return (0, i.createElement)(et, (0, l.Z)({}, u, a, {
                        ref: t,
                        align: r,
                        collisionPadding: o,
                        style: {
                ...
                eN = (0, i.forwardRef)((e, t) => {
                    let {
                        __scopeSelect: n,
                        ...r
                    } = e, o = e_(eB, n), a = eF(eB, n), u = (0, d.e)(t, o.onViewportChange), c = (0, i.useRef)(0);
                    return (0, i.createElement)(i.Fragment, null, (0, i.createElement)("style", {
                        ...
                        scope: n
                    }, (0, i.createElement)(h.WV.div, (0, l.Z)({
                ...
                eU = (0, i.forwardRef)((e, t) => {
                    let {
                        ...
                        textValue: a,
                        ...u
                    } = e, c = eS(ez, n), f = e_(ez, n), p = c.value === r, [m, v] = (0, i.useState)(null != a ? a : ""), [g, y] = (0, i.useState)(!1), w = (0, d.e)(t, e => {
                        var t;
                        return null === (t = f.itemRefCallback) || void 0 === t ? void 0 : t.call(f, e, r, o)
                    }), x = (0, M.M)(), b = () => {
                    ...
                    return (0, i.createElement)(e$, {
                        ...
                        onKeyDown: (0, s.M)(u.onKeyDown, e => {
                            ...
                            n && " " === e.key || (em.includes(e.key) && b(), " " === e.key && e.preventDefault())
                        })
                    }))))
                }),
                eq = "SelectItemText",
                eY = (0, i.forwardRef)((e, t) => {
                    let {
                        ...
                        style: o,
                        ...u
                    } = e, s = eS(eq, n), c = e_(eq, n), f = ej(eq, n), p = eP(eq, n), [m, v] = (0, i.useState)(null), g = (0, d.e)(t, e => v(e), f.onItemTextChange, e => {
                        var t;
                    ...
                    return (0, Z.b)(() => (x(w), () => b(w)), [x, b, w]), (0, i.createElement)(i.Fragment, null, (0, i.createElement)(h.WV.span, (0, l.Z)({
                        id: f.textId
                    }, u, {
                        ref: g
                    })), f.isSelected && s.valueNode && !s.valueNodeHasChildren ? (0, a.createPortal)(u.children, s.valueNode) : null)
                }),
                ...
                eJ = (0, i.forwardRef)((e, t) => {
                    ...
                    }, [n.viewport, n.isPositioned]), o ? (0, i.createElement)(e0, (0, l.Z)({}, e, {
                        ref: u,
                        onAutoScroll: () => {
                            let {
                                viewport: e,
                ...
                e1 = (0, i.forwardRef)((e, t) => {
                    let {
                        value: n,
                        ...r
                    } = e, o = (0, i.useRef)(null), a = (0, d.e)(t, o), u = (0, es.D)(n);
                    return (0, i.useEffect)(() => {
                        let e = o.current,
                    ...
                    }, [u, n]), (0, i.createElement)(ec.T, {
                        asChild: !0
                    }, (0, i.createElement)("select", (0, l.Z)({}, r, {
                        ref: a,
                        defaultValue: n
                    })))
                });
