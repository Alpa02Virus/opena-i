...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [1703], {
        1703: function(e, t, s) {
            ...
            function k(e) {
                if (e && "object" == typeof e) switch (e[h]) {
                    case a:
                    case f:
                        return !0
                }
            ...
            function x(e, t, s, n) {
                return "function" == typeof s ? s(e, t, n) : m(t) ? s.Map ? .(e, t, n) : b(t) ? s.Seq ? .(e, t, n) : y(t) ? s.Pair ? .(e, t, n) : g(t) ? s.Scalar ? .(e, t, n) : d(t) ? s.Alias ? .(e, t, n) : void 0
            }
            ...
            O.BREAK = S, O.SKIP = E, O.REMOVE = N, T.BREAK = S, T.SKIP = E, T.REMOVE = N;
            let C = {
                    "!": "%21",
                    ",": "%2C",
                    "[": "%5B",
            ...
            class B {
                ...
                add(e, t) {
                    this.atNextDocument && (this.yaml = {
                        explicit: B.defaultYaml.explicit,
                        version: "1.1"
                    }, this.tags = Object.assign({}, B.defaultTags), this.atNextDocument = !1);
                    let s = e.trim().split(/[ \t]+/),
                        n = s.shift();
                    switch (n) {
                        case "%TAG":
                            {
                                ...
                                let [e, n] = s;
                                return this.tags[e] = n,
                                !0
                            }
                        case "%YAML":
                            {
                                if (this.yaml.explicit = !0, 1 !== s.length) return t(0, "%YAML directive should contain exactly one part"), !1;
                                let [e] = s;
                ...
                tagName(e, t) {
                    ...
                    if ("<" === e[1]) {
                        let s = e.slice(2, -1);
                        return "!" === s || "!!" === s ? (t(`Verbatim tags aren't resolved, so ${e} is invalid.`), null) : (">" !== e[e.length - 1] && t("Verbatim tags must end with a >"), s)
                    }
                    let [, s, n] = e.match(/^(.*!)([^!]*)$/);
                    n || t(`The ${e} tag has no suffix`);
                    let i = this.tags[s];
                    return i ? i + decodeURIComponent(n) : "!" === s ? e : (t(`Could not resolve tag: ${e}`), null)
                }
                tagString(e) {
                ...
                toString(e) {
                    let t;
                    let s = this.yaml.explicit ? [`%YAML ${this.yaml.version||"1.2"}`] : [],
                    ...
                    for (let [i, r] of n)("!!" !== i || "tag:yaml.org,2002:" !== r) && (!e || t.some(e => e.startsWith(r))) && s.push(`%TAG ${i} ${r}`);
                    return s.join("\n")
                }
            }
            ...
            function P(e, t, s) {
                ...
                if (e && "function" == typeof e.toJSON) {
                    ...
                    s.anchors.set(e, n), s.onCreate = e => {
                ...
                toJS(e, {
                    ...
                    if ("function" == typeof n)
                        for (let {
                                count: e,
                                res: t
                            } of r.anchors.values()) n(t, e);
                    return "function" == typeof i ? q(i, {
                        "": o
                    }, "", o) : o
                }
            }
            class U extends K {
                constructor(e) {
                    super(o), this.source = e, Object.defineProperty(this, "tag", {
                        set() {
                ...
                toJSON(e, t) {
                    ...
                    let o = s.get(r);
                    if (o || (P(r, null, t), o = s.get(r)), !o || void 0 === o.res) throw ReferenceError("This should not happen: Alias anchor was not resolved?");
                    if (i >= 0 && (o.count += 1, 0 === o.aliasCount && (o.aliasCount = function e(t, s, n) {
                            if (d(s)) {
                                let e = s.resolve(t),
                                    i = n && e && n.get(e);
                            ...
                            return 1
                        }(n, r, s)), o.count * o.aliasCount > i)) throw ReferenceError("Excessive alias count indicates a resource exhaustion attack");
                    return o.res
                }
                toString(e, t, s) {
                    let n = `*${this.source}`;
                    if (e) {
                        if (M(this.source), e.options.verifyAliasOrder && !e.anchors.has(this.source)) {
                            let e = `Unresolved alias (the anchor must be set before the alias): ${this.source}`;
                            throw Error(e)
                        }
            ...
            function V(e, t, s) {
                ...
                if (i && e && "object" == typeof e) {
                    if (n = c.get(e)) return n.anchor || (n.anchor = r(e)), new U(n.anchor);
                    n = {
                        anchor: null,
                        node: null
                    }, c.set(e, n)
                ...
                if (!u) {
                    ...
                    u = e instanceof Map ? l[a] : Symbol.iterator in Object(e) ? l[f] : l[a]
                }
                o && (o(u), delete s.onTagObj);
                let h = u ? .createNode ? u.createNode(s.schema, e, s) : "function" == typeof u ? .nodeClass ? .from ? u.nodeClass.from(s.schema, e, s) : new F(e);
                return t ? h.tag = t : u.default || (h.tag = u.tag), n && (n.node = h), h
            }
            ...
            let Y = e => null == e || "object" == typeof e && !!e[Symbol.iterator]().next().done;
            class W extends K {
                constructor(e, t) {
                ...
                clone(e) {
                    ...
                    return e && (t.schema = e), t.items = t.items.map(t => w(t) || y(t) ? t.clone(e) : t), this.range && (t.range = this.range.slice()), t
                }
                addIn(e, t) {
                    if (Y(e)) this.add(t);
                    else {
                        let [s, ...n] = e, i = this.get(s, !0);
                        if (k(i)) i.addIn(n, t);
                        else if (void 0 === i && this.schema) this.set(s, J(this.schema, n, t));
                ...
                getIn(e, t) {
                    let [s, ...n] = e, i = this.get(s, !0);
                    return 0 === n.length ? !t && g(i) ? i.value : i : k(i) ? i.getIn(n, t) : void 0
                }
                hasAllNullValues(e) {
                    return this.items.every(t => {
                        if (!y(t)) return !1;
                        let s = t.value;
                        return null == s || e && g(s) && null == s.value && !s.commentBefore && !s.comment && !s.tag
                    })
                }
                hasIn(e) {
                    let [t, ...s] = e;
                ...
                setIn(e, t) {
                    ...
                    if (0 === n.length) this.set(s, t);
                        ...
                        let e = this.get(s, !0);
                        if (k(e)) e.setIn(n, t);
                        else if (void 0 === e && this.schema) this.set(s, J(this.schema, n, t));
                        else throw Error(`Expected YAML collection at ${s}. Remaining path: ${n}`)
                    }
                }
            }
            ...
            let H = (e, t, s) => e.endsWith("\n") ? Q(s, t) : s.includes("\n") ? "\n" + Q(s, t) : (e.endsWith(" ") ? "" : " ") + s,
                X = "flow",
                z = "block",
                Z = "quoted";

            function ee(e, t, s = "flow", {
                indentAtStart: n,
                lineWidth: i = 80,
                ...
                let h = [],
                    d = {},
                    p = i - t.length;
                "number" == typeof n && (n > i - Math.max(2, r) ? h.push(0) : p = i - n);
                let m = !1,
                    y = -1,
                    g = -1,
                    b = -1;
                for (s === z && -1 !== (y = et(e, y)) && (p = y + f); u = e[y += 1];) {
                    if (s === Z && "\\" === u) {
                        switch (g = y, e[y + 1]) {
                            case "x":
                                y += 3;
...
${t}${e.slice(i+1,r)}`)
            ...
            function ei(e, t) {
                ...
                let {
                    implicitKey: n
                } = t, i = t.options.doubleQuotedMinMultiLineLength, r = t.indent || (en(e) ? "  " : ""), o = "", l = 0;
                for (let e = 0, t = s[e]; t; t = s[++e])
                    if (" " === t && "\\" === s[e + 1] && "n" === s[e + 2] && (o += s.slice(l, e) + "\\ ", e += 1, l = e, t = "\\"), "\\" === t) switch (s[e + 1]) {
                        case "u":
                            {
                                o += s.slice(l, e);
...
${s}`) + "'";
            ...
            function el({
                ...
                let d = i.indent || (i.forceBlockIndent || en(s) ? "  " : ""),
                    p = "literal" === u || "folded" !== u && t !== F.BLOCK_FOLDED && (t === F.BLOCK_LITERAL || ! function(e, t, s) {
                        if (!t || t < 0) return !1;
                        let n = t - s,
                            i = e.length;
                        if (i <= n) return !1;
...
${d}${v}`
            ...
            function ea(e, t, s, n) {
                ...
                l !== F.QUOTE_DOUBLE && /[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(o.value) && (l = F.QUOTE_DOUBLE);
                let a = e => {
                        switch (e) {
                            case F.BLOCK_FOLDED:
                            ...
                            case F.PLAIN:
                                return function(e, t, s, n) {
                                    ...
                                    if (l && r.includes("\n") || u && /[[\]{},]/.test(r)) return eo(r, t);
                                    if (!r || /^[\n\t ,[\]{}#&*!|>'"%@`]|^[?-]$|^[?-][ \t]|[\n:][ \t]|[ \t]\n|[\n\t ]#|[\n\t :]$/.test(r)) return l || u || !r.includes("\n") ? eo(r, t) : el(e, t, s, n);
                                    if (!l && !u && i !== F.PLAIN && r.includes("\n")) return el(e, t, s, n);
                                    if (en(r)) {
                                        if ("" === a) return t.forceBlockIndent = !0, el(e, t, s, n);
...
${a}`);
            ...
            function eu(e, t, s, n) {
                ...
                let r = w(e) ? e : t.doc.createNode(e, {
                    onTagObj: e => i = e
                });
                i || (i = function(e, t) {
                    let s, n;
                ...
                let l = "function" == typeof i.stringify ? i.stringify(r, t, s, n) : g(r) ? ea(r, t, s, n) : r.toString(t, s, n);
                return o ? g(r) || "{" === l[0] || "[" === l[0] ? `${o} ${l}` : `${o}
${t.indent}${l}` : l
            }
            var ef = s(44675);

            function eh(e, t) {
                ("debug" === e || "warn" === e) && (void 0 !== ef && ef.emitWarning ? ef.emitWarning(t) : console.warn(t))
            }
                        ...
                        let r = function(e, t, s) {
                                ...
                                if (w(e) && s ? .doc) {
                                    ...
                                    if (!s.mapKeyWarned) {
                                        ...
                                        e.length > 40 && (e = e.substring(0, 36) + '..."'), eh(s.doc.options.logLevel, `Keys with collection values will be stringified due to JS Object restrictions: ${e}. Set mapAsMap: true to use object keys.`), s.mapKeyWarned = !0
                                    }
                                    return n
                                }
            ...
            let ep = e => "<<" === e || g(e) && "<<" === e.value && (!e.type || e.type === F.PLAIN);

            function em(e, t, s) {
                let n = e && d(s) ? s.resolve(e.doc) : s;
                if (!m(n)) throw Error("Merge sources must be maps or map aliases");
                let i = n.toJSON(null, e, Map);
                for (let [e, s] of i) t instanceof Map ? t.has(e) || t.set(e, s) : t instanceof Set ? t.add(e) : Object.prototype.hasOwnProperty.call(t, e) || Object.defineProperty(t, e, {
                    value: s,
                    writable: !0,
                    enumerable: !0,
                    configurable: !0
            ...
            class eg {
                ...
                clone(e) {
                    ...
                    return w(t) && (t = t.clone(e)), w(s) && (s = s.clone(e)), new eg(t, s)
                }
                toJSON(e, t) {
                ...
                toString(e, t, s) {
                    return e ? .doc ? function({
                        ...
                        } = s, m = w(e) && e.comment || null;
                        if (p) {
                            if (m) throw Error("With simple keys, key nodes cannot have comments");
                            if (k(e)) throw Error("With simple keys, collection cannot be used as a key value")
                        }
                        let y = !p && (!e || m && null == t && !s.inFlow || k(e) || (g(e) ? e.type === F.BLOCK_FOLDED || e.type === F.BLOCK_LITERAL : "object" == typeof e));
                        s = Object.assign({}, s, {
                            allNullValues: !1,
                            implicitKey: !y && (p || !a),
                            indent: u + f
                        ...
                        if (s.inFlow) {
                            if (a || null == t) return v && n && n(), "" === E ? "?" : y ? `? ${E}` : E
                        } else if (a && !p || null == t && y) return E = `? ${E}`, m && !v ? E += H(E, s.indent, h(m)) : S && i && i(), E;
                        v && (m = null), y ? (m && (E += H(E, s.indent, h(m))), E = `? ${E}
${u}:`) : (E = `${E}:`, m && (E += H(E, s.indent, h(m)))), w(t) ? (r = !!t.spaceBefore, o = t.commentBefore, l = t.comment) : (r = !1, o = null, l = null, t && "object" == typeof t && (t = c.createNode(t))), s.implicitKey = !1, !y && !m && g(t) && (s.indentAtStart = E.length + 1), S = !1, !(!d && f.length >= 2 && !s.inFlow && !y && b(t)) || t.flow || t.tag || t.anchor || (s.indent = s.indent.substring(2));
                        let N = !1,
                            O = eu(t, s, () => N = !0, () => S = !0),
                            A = " ";
                        if (m || r || o) {
...
${s.indent}` : "\n" === A && (A = "\n\n")
                            ...
                            if (i || !r) {
                                ...
                                if (i && ("&" === e || "!" === e)) {
                                    let s = O.indexOf(" ");
                                    "&" === e && -1 !== s && s < n && "!" === O[s + 1] && (s = O.indexOf(" ", s + 1)), (-1 === s || n < s) && (t = !0)
                                }
                                t || (A = `
${s.indent}`)
                            }
                        } else("" === O || "\n" === O[0]) && (A = "");
                        return E += A + O, s.inFlow ? N && n && n() : l && !N ? E += H(E, s.indent, h(l)) : S && i && i(), E
                    }(this, e, t, s) : JSON.stringify(this)
                }
            }
            ...
            function ek({
                ...
                for (let e = 0; e < t.length; ++e) {
                    let i = t[e],
                        o = null;
                    if (w(i)) !h && i.spaceBefore && d.push(""), ev(s, d, i.commentBefore, h), i.comment && (o = i.comment);
                    else if (y(i)) {
                        let e = w(i.key) ? i.key : null;
                        e && (!h && e.spaceBefore && d.push(""), ev(s, d, e.commentBefore, h))
                    }
                    h = !1;
                    let l = eu(i, f, () => o = null, () => h = !0);
...
${c}${t}` : "\n"
            ...
            function ew({
                ...
                for (let e = 0; e < t.length; ++e) {
                    let n = t[e],
                        r = null;
                    if (w(n)) n.spaceBefore && p.push(""), ev(s, p, n.commentBefore, !1), n.comment && (r = n.comment);
                    else if (y(n)) {
                        let e = w(n.key) ? n.key : null;
                        e && (e.spaceBefore && p.push(""), ev(s, p, e.commentBefore, !1), e.comment && (h = !0));
                        let t = w(n.value) ? n.value : null;
                        t ? (t.comment && (r = t.comment), t.commentBefore && (h = !0)) : null == n.value && e ? .comment && (r = e.comment)
                    }
                    r && (h = !0);
                    let o = eu(n, f, () => r = null);
                    e < t.length - 1 && (o += ","), r && (o += H(o, i, u(r))), !h && (p.length > d || o.includes("\n")) && (h = !0), p.push(o), d = p.length
                }
                let {
                    start: m,
                    end: g
...
${l}${g}`
            ...
            function eS(e, t) {
                let s = g(t) ? t.value : t;
                for (let n of e)
                    if (y(n) && (n.key === t || n.key === s || g(n.key) && n.key.value === s)) return n
            }
            class eE extends W {
                static get tagName() {
                ...
                add(e, t) {
                    let s;
                    s = y(e) ? e : e && "object" == typeof e && "key" in e ? new eg(e.key, e.value) : new eg(e, e ? .value);
                    let n = eS(this.items, s.key),
                        i = this.schema ? .sortMapEntries;
                    if (n) {
                        if (!t) throw Error(`Key ${s.key} already set`);
                        g(n.value) && R(s.value) ? n.value.value = s.value : n.value = s.value
                    } else if (i) {
                        let e = this.items.findIndex(e => 0 > i(s, e)); - 1 === e ? this.items.push(s) : this.items.splice(e, 0, s)
                ...
                toString(e, t, s) {
                    ...
                    for (let e of this.items)
                        if (!y(e)) throw Error(`Map items must all be pairs; found ${JSON.stringify(e)} instead`);
            ...
            let eT = {
                ...
                eI = {
                    ...
                    resolve: e => e,
                    stringify: (e, t, s, n) => ea(e, t = Object.assign({
                        actualString: !0
                    }, t), s, n)
                },
                eL = {
                    ...
                    stringify: ({
                        source: e
                    }, t) => "string" == typeof e && eL.test.test(e) ? e : t.options.nullStr
                },
                ex = {
            ...
            let eY = {
                ...
                stringify({
                    ...
                    let o;
                    if ("function" == typeof eJ) o = s instanceof eJ ? s.toString("base64") : eJ.from(s.buffer).toString("base64");
...
${e.key.commentBefore}` : n.commentBefore), n.comment) {
                                    let t = e.value ? ? e.key;
                                    t.comment = t.comment ? `${n.comment}
${t.comment}` : n.comment
                                }
                                n = e
                            }
            ...
            class eH extends eO {
                constructor() {
                    super(), this.add = eE.prototype.add.bind(this), this.delete = eE.prototype.delete.bind(this), this.get = eE.prototype.get.bind(this), this.has = eE.prototype.has.bind(this), this.set = eE.prototype.set.bind(this), this.tag = eH.tag
                }
                toJSON(e, t) {
                    ...
                    for (let e of (t ? .onCreate && t.onCreate(s), this.items)) {
                        let n, i;
                        if (y(e) ? (n = P(e.key, "", t), i = P(e.value, n, t)) : n = P(e, "", t), s.has(n)) throw Error("Ordered maps must not include duplicate keys");
                        s.set(n, i)
                    }
                    return s
                }
            ...
            let eX = {
                ...
                resolve(e, t) {
                    ...
                    for (let {
                            key: e
                        } of s.items) g(e) && (n.includes(e.value) ? t(`Ordered maps must not include duplicate keys: ${e.value}`) : n.push(e.value));
            ...
            function ez({
                ...
                return t && (e ? eZ : e0).test.test(t) ? t : e ? s.options.trueStr : s.options.falseStr
            }
            let eZ = {
                    identify: e => !0 === e,
                    default: !0,
            ...
            class e8 extends eE {
                ...
                add(e) {
                    let t;
                    t = y(e) ? e : e && "object" == typeof e && "key" in e && "value" in e && null === e.value ? new eg(e.key, null) : new eg(e, null);
                ...
                set(e, t) {
                    ...
                    let s = eS(this.items, e);
                    s && !t ? this.items.splice(this.items.indexOf(s), 1) : !s && t && this.items.push(new eg(e))
                }
                toJSON(e, t) {
                ...
                static from(e, t, s) {
                    ...
                    if (t && Symbol.iterator in Object(t))
                        for (let e of t) "function" == typeof n && (e = n.call(t, e, e)), i.items.push(ey(e, null, s));
                    return i
                }
            }
            ...
            function e6(e, t) {
                let s = e[0],
                    ...
                    r = n.replace(/_/g, "").split(":").reduce((e, t) => e * i(60) + i(t), i(0));
                return "-" === s ? i(-1) * r : r
            }
            ...
            function e3(e) {
                ...
                let i = s(60),
                    r = [t % i];
                return t < 60 ? r.unshift(0) : (t = (t - r[0]) / i, r.unshift(t % i), t >= 60 && (t = (t - r[0]) / i, r.unshift(t))), n + r.map(e => String(e).padStart(2, "0")).join(":").replace(/000000\d*$/, "")
            }
            let e7 = {
                ...
                te = {
                    ...
                    resolve(e) {
                        ...
                        let [, s, n, i, r, o, l] = t.map(Number), a = t[7] ? Number((t[7] + "00").substr(1, 3)) : 0, c = Date.UTC(s, n - 1, i, r || 0, o || 0, l || 0, a), u = t[8];
                        if (u && "Z" !== u) {
                            let e = e6(u, !1);
            ...
            function tr(e, t) {
                ...
                if (!s) {
                    if (Array.isArray(e)) s = [];
                        ...
                        let e = Array.from(ts.keys()).filter(e => "yaml11" !== e).map(e => JSON.stringify(e)).join(", ");
                        throw Error(`Unknown schema "${t}"; use one of ${e} or define customTags array`)
                    }
                }
                if (Array.isArray(e))
                    for (let t of e) s = s.concat(t);
                else "function" == typeof e && (s = e(s.slice()));
                return s.map(e => {
                    if ("string" != typeof e) return e;
                    let t = tn[e];
                    if (t) return t;
                    let s = Object.keys(tn).map(e => JSON.stringify(e)).join(", ");
            ...
            class tl {
                constructor({
                    ...
                    this.compat = Array.isArray(e) ? tr(e, "compat") : e ? tr(null, e) : null, this.merge = !!s, this.name = "string" == typeof i && i || "core", this.knownTags = n ? ti : {}, this.tags = tr(t, this.name), this.toStringOptions = o ? ? null, Object.defineProperty(this, a, {
                        value: eN
                    }), Object.defineProperty(this, u, {
                        value: eI
                    }), Object.defineProperty(this, f, {
                        value: eT
                    }), this.sortMapEntries = "function" == typeof r ? r : !0 === r ? to : null
                }
                clone() {
                    let e = Object.create(tl.prototype, Object.getOwnPropertyDescriptors(this));
                    return e.tags = this.tags.slice(), e
                }
            }
            class ta {
                constructor(e, t, s) {
                    this.commentBefore = null, this.comment = null, this.errors = [], this.warnings = [], Object.defineProperty(this, h, {
                        value: l
                    });
                    let n = null;
                    ...
                    s ? ._directives ? (this.directives = s._directives.atDocument(), this.directives.yaml.explicit && (r = this.directives.yaml.version)) : this.directives = new B({
                        version: r
                    }), this.setSchema(r, s), this.contents = void 0 === e ? null : this.createNode(e, n, s)
                }
                clone() {
                    let e = Object.create(ta.prototype, {
                        [h]: {
                            value: l
                        }
                    });
                    return e.commentBefore = this.commentBefore, e.comment = this.comment, e.errors = this.errors.slice(), e.warnings = this.warnings.slice(), e.options = Object.assign({}, this.options), this.directives && (e.directives = this.directives.clone()), e.schema = this.schema.clone(), e.contents = w(this.contents) ? this.contents.clone(e.schema) : this.contents, this.range && (e.range = this.range.slice()), e
                }
                add(e) {
                    ...
                    let {
                        ...
                        return {
                            ...
                            setAnchors: () => {
                                for (let e of s) {
                                    let t = n.get(e);
                                    if ("object" == typeof t && t.anchor && (g(t.node) || k(t.node))) t.node.anchor = t.anchor;
                                    else {
                ...
                deleteIn(e) {
                    return Y(e) ? null != this.contents && (this.contents = null, !0) : !!tc(this.contents) && this.contents.deleteIn(e)
                }
                get(e, t) {
                    return k(this.contents) ? this.contents.get(e, t) : void 0
                }
                getIn(e, t) {
                    return Y(e) ? !t && g(this.contents) ? this.contents.value : this.contents : k(this.contents) ? this.contents.getIn(e, t) : void 0
                }
                has(e) {
                    return !!k(this.contents) && this.contents.has(e)
                }
                hasIn(e) {
                    return Y(e) ? void 0 !== this.contents : !!k(this.contents) && this.contents.hasIn(e)
                }
                set(e, t) {
                    null == this.contents ? this.contents = J(this.schema, [e], t) : tc(this.contents) && this.contents.set(e, t)
                }
                setIn(e, t) {
                    Y(e) ? this.contents = t : null == this.contents ? this.contents = J(this.schema, Array.from(e), t) : tc(this.contents) && this.contents.setIn(e, t)
                }
                setSchema(e, t = {}) {
                    let s;
                    switch ("number" == typeof e && (e = String(e)), e) {
                        case "1.1":
                            this.directives ? this.directives.yaml.version = "1.1" : this.directives = new B({
                                version: "1.1"
                            }), s = {
                                merge: !0,
                                resolveKnownTags: !1,
                        ...
                        case "1.2":
                        case "next":
                            this.directives ? this.directives.yaml.version = e : this.directives = new B({
                                version: e
                            }), s = {
                                merge: !1,
                                resolveKnownTags: !0,
                ...
                toString(e = {}) {
                    ...
                    return function(e, t) {
                        ...
                        if (e.contents) {
                            ...
                            l && (a += H(a, "", r(l))), ("|" === a[0] || ">" === a[0]) && "---" === s[s.length - 1] ? s[s.length - 1] = `--- ${a}` : s.push(a)
                        } else s.push(eu(e.contents, i));
                        if (e.directives ? .docEnd) {
                            if (e.comment) {
                                let t = r(e.comment);
                                t.includes("\n") ? (s.push("..."), s.push(Q(t, ""))) : s.push(`... ${t}`)
                            } else s.push("...")
                        } else {
                            let t = e.comment;
                            t && o && (t = t.replace(/^\n+/, "")), t && ((!o || l) && "" !== s[s.length - 1] && s.push(""), s.push(Q(r(t), "")))
                        }
                        return s.join("\n") + "\n"
                    }(this, e)
                }
...
`
            ...
            function tp(e, {
                ...
                let l = !1,
                    ...
                    b = null,
                    k = null;
                for (let n of e) switch (p && ("space" !== n.type && "newline" !== n.type && "comma" !== n.type && r(n.offset, "MISSING_CHAR", "Tags and anchors must be separated from the next token by white space"), p = !1), n.type) {
                    case "space":
                        !t && a && "doc-start" !== s && "	" === n.source[0] && r(n, "TAB_AS_INDENT", "Tabs are not allowed as indentation"), c = !0;
                        break;
                    case "comment":
                        {
                            c || r(n, "MISSING_CHAR", "Comments must be separated from other tokens by white space characters");
                            let e = n.source.substring(1) || " ";u ? u += f + e : u = e,
                            f = "",
                            a = !1;
                            break
                        }
                    case "newline":
                        a ? u ? u += n.source : l = !0 : f += n.source, a = !0, h = !0, (m || y) && (d = !0), c = !0;
                        break;
                    case "anchor":
                        m && r(n, "MULTIPLE_ANCHORS", "A node can have at most one anchor"), n.source.endsWith(":") && r(n.offset + n.source.length - 1, "BAD_ALIAS", "Anchor ending in : is ambiguous", !0), m = n, null === k && (k = n.offset), a = !1, c = !1, p = !0;
                        break;
                    case "tag":
                        y && r(n, "MULTIPLE_TAGS", "A node can have at most one tag"), y = n, null === k && (k = n.offset), a = !1, c = !1, p = !0;
                        break;
                    case s:
                        (m || y) && r(n, "BAD_PROP_ORDER", `Anchors and tags must be after the ${n.source} indicator`), b && r(n, "UNEXPECTED_TOKEN", `Unexpected ${n.source} in ${t??"collection"}`), b = n, a = !1, c = !1;
                        break;
                    case "comma":
                        if (t) {
                            g && r(n, "UNEXPECTED_TOKEN", `Unexpected , in ${t}`), g = n, a = !1, c = !1;
                            break
                        }
                    default:
                        r(n, "UNEXPECTED_TOKEN", `Unexpected ${n.type} token`), a = !1, c = !1
                }
                let w = e[e.length - 1],
                    v = w ? w.offset + w.source.length : i;
                return p && n && "space" !== n.type && "newline" !== n.type && "comma" !== n.type && ("scalar" !== n.type || "" !== n.source) && r(n.offset, "MISSING_CHAR", "Tags and anchors must be separated from the next token by white space"), {
                    comma: g,
                    found: b,
                    spaceBefore: l,
                    comment: u,
            ...
            function ty(e, t, s) {
                if (t ? .type === "flow-collection") {
                    let n = t.end[0];
                    n.indent === e && ("]" === n.source || "}" === n.source) && tm(t) && s(n, "BAD_INDENT", "Flow end indicator should be more indented than parent", !0)
                }
            }
            ...
            function tg(e, t, s) {
                ...
                if (!1 === n) return !1;
                let i = "function" == typeof n ? n : (t, s) => t === s || g(t) && g(s) && t.value === s.value && !("<<" === t.value && e.schema.merge);
            ...
            function tS(e, t, s, n, i, r) {
                let o = "block-map" === s.type ? function({
                        composeNode: e,
                        composeEmptyNode: t
                    }, s, n, i, r) {
                        ...
                        for (let r of n.items) {
                            ...
                            if (p) {
                                if (u && ("block-seq" === u.type ? i(a, "BLOCK_AS_IMPLICIT_KEY", "A block sequence may not be used as an implicit map key") : "indent" in u && u.indent !== n.indent && i(a, "BAD_INDENT", tb)), !d.anchor && !d.tag && !f) {
                                    c = d.end, d.comment && (l.comment ? l.comment += "\n" + d.comment : l.comment = d.comment);
                                    continue
                                }(d.hasNewlineAfterProp || tm(u)) && i(u ? ? o[o.length - 1], "MULTILINE_IMPLICIT_KEY", "Implicit keys need to be on a single line")
                            } else d.found ? .indent !== n.indent && i(a, "BAD_INDENT", tb);
                            let m = d.end,
                                y = u ? e(s, u, d, i) : t(s, m, o, null, d, i);
                            s.schema.compat && ty(n.indent, u, i), tg(s, l.items, y) && i(m, "DUPLICATE_KEY", "Map keys must be unique");
                            let g = tp(f ? ? [], {
                            ...
                            if (a = g.end, g.found) {
                                p && (h ? .type !== "block-map" || g.hasNewline || i(a, "BLOCK_AS_IMPLICIT_KEY", "Nested mappings are not allowed in compact mappings"), s.options.strict && d.start < g.found.offset - 1024 && i(y.range, "KEY_OVER_1024_CHARS", "The : indicator must be at most 1024 chars after the start of an implicit block mapping key"));
                                let o = h ? e(s, h, g, i) : t(s, a, f, null, g, i);
                                s.schema.compat && ty(n.indent, h, i), a = o.range[2];
                                let c = new eg(y, o);
                                s.options.keepSourceTokens && (c.srcToken = r), l.items.push(c)
                            } else {
                                p && i(y.range, "MISSING_CHAR", "Implicit map keys need to be followed by map values"), g.comment && (y.comment ? y.comment += "\n" + g.comment : y.comment = g.comment);
                                let e = new eg(y);
                                s.options.keepSourceTokens && (e.srcToken = r), l.items.push(e)
                            }
                        }
                        return c && c < a && i(c, "IMPOSSIBLE", "Map comment with trailing content"), l.range = [n.offset, a, c ? ? a], l
                    }(e, t, s, n, r) : "block-seq" === s.type ? function({
                        composeNode: e,
                        composeEmptyNode: t
                    }, s, n, i, r) {
                        ...
                        for (let {
                            ...
                            if (!u.found) {
                                if (u.anchor || u.tag || o) o && "block-seq" === o.type ? i(u.end, "BAD_INDENT", "All sequence items must start at the same column") : i(a, "MISSING_CHAR", "Sequence item without - indicator");
                                else {
                            ...
                            s.schema.compat && ty(n.indent, o, i), a = f.range[2], l.items.push(f)
                        }
                        ...
                        for (let r = 0; r < n.items.length; ++r) {
                            ...
                            if (!m.found) {
                                if (!m.anchor && !m.tag && !d && !p) {
                                    0 === r && m.comma ? i(m.comma, "UNEXPECTED_TOKEN", `Unexpected , in ${l}`) : r < n.items.length - 1 && i(m.start, "UNEXPECTED_TOKEN", `Unexpected empty item in ${l}`), m.comment && (c.comment ? c.comment += "\n" + m.comment : c.comment = m.comment), f = m.end;
                                    continue
                                }!o && s.options.strict && tm(h) && i(h, "MULTILINE_IMPLICIT_KEY", "Implicit keys of flow sequence pairs need to be on a single line")
                            }
                            if (0 === r) m.comma && i(m.comma, "UNEXPECTED_TOKEN", `Unexpected , in ${l}`);
                            else if (m.comma || i(m.start, "MISSING_CHAR", `Missing , between ${l} items`), m.comment) {
                                let e = "";
                                e: for (let t of u) switch (t.type) {
                                    case "comma":
                                    case "space":
                                        break;
                                    case "comment":
                            ...
                            if (o || d || m.found) {
                                ...
                                } else p && ("source" in p && p.source && ":" === p.source[0] ? i(p, "MISSING_CHAR", `Missing space after : in ${l}`) : i(y.start, "MISSING_CHAR", `Missing , or : between ${l} items`));
                                let g = p ? e(s, p, y, i) : y.found ? t(s, y.end, d, null, y, i) : null;
                                g ? tv(p) && i(g.range, "BLOCK_IN_FLOW", tw) : y.comment && (r.comment ? r.comment += "\n" + y.comment : r.comment = y.comment);
                                let b = new eg(r, g);
                                if (s.options.keepSourceTokens && (b.srcToken = a), o) tg(s, c.items, r) && i(n, "DUPLICATE_KEY", "Map keys must be unique"), c.items.push(b);
                                else {
                                ...
                                c.items.push(n), f = n.range[2], tv(p) && i(n.range, "BLOCK_IN_FLOW", tw)
                            }
                        }
                        let h = o ? "}" : "]",
                            [d, ...p] = n.end,
                        ...
                        if (d && d.source === h) m = d.offset + d.source.length;
                            ...
                            let e = l[0].toUpperCase() + l.substring(1),
                                t = u ? `${e} must end with a ${h}` : `${e} in block collection must be sufficiently indented and end with a ${h}`;
                            i(f, u ? "MISSING_CHAR" : "BAD_INDENT", t), d && 1 !== d.source.length && p.unshift(d)
                        }
                        if (p.length > 0) {
            ...
            function tE(e, t, s) {
                let n = e.offset,
                    i = function({
                        ...
                        if ("block-scalar-header" !== t[0].type) return n(t[0], "IMPOSSIBLE", "Block scalar header not found"), null;
                        let {
                            source: i
                        } = t[0], r = i[0], o = 0, l = "", a = -1;
                        ...
                        for (let e = 1; e < t.length; ++e) {
                            ...
                            switch (i.type) {
                                ...
                                case "newline":
                                    ...
                                    break;
                                case "comment":
                                    s && !c && n(i, "MISSING_CHAR", "Comments must be separated from other tokens by white space characters"), f += i.source.length, u = i.source.substring(1);
                                    break;
                                case "error":
                                ...
                                default:
                                    {
                                        let e = `Unexpected token in block scalar header: ${i.type}`;n(i, "UNEXPECTED_TOKEN", e);
                ...
                if (0 === l) {
                    let t = "+" === i.chomp && o.length > 0 ? "\n".repeat(Math.max(1, o.length - 1)) : "",
                        s = n + i.length;
                    return e.source && (s += e.source.length), {
                        value: t,
                        type: r,
                        comment: i.comment,
                        range: [n, s, s]
                ...
                for (let e = 0; e < l; ++e) {
                    let [t, n] = o[e];
                    if ("" === n || "\r" === n) 0 === i.indent && t.length > a && (a = t.length);
                    else {
                        t.length < a && s(c + t.length, "MISSING_CHAR", "Block scalars with more-indented leading empty lines must use an explicit indentation indicator"), 0 === i.indent && (a = t.length), u = e;
                        break
                    }
                ...
                for (let e = u; e < l; ++e) {
                    ...
                    r === F.BLOCK_LITERAL ? (f += h + t.slice(a) + n, h = "\n") : t.length > a || "	" === n[0] ? (" " === h ? h = "\n" : d || "\n" !== h || (h = "\n\n"), f += h + t.slice(a) + n, h = "\n", d = !0) : "" === n ? "\n" === h ? f += "\n" : h = "\n" : (f += h + n, h = " ", d = !1)
                }
                switch (i.chomp) {
                    case "-":
                        break;
                ...
                switch (o) {
                    case "scalar":
                        n = F.PLAIN, i = function(e, t) {
                            ...
                            return s && t(0, "BAD_SCALAR_START", `Plain value cannot start with ${s}`), tO(e)
                        }(l, c);
                        break;
                    case "single-quoted-scalar":
                        n = F.QUOTE_SINGLE, ("'" !== l[l.length - 1] || 1 === l.length) && c(l.length, "MISSING_CHAR", "Missing closing 'quote"), i = tO(l.slice(1, -1)).replace(/''/g, "'");
                        break;
                    case "double-quoted-scalar":
                        n = F.QUOTE_DOUBLE, i = function(e, t) {
                            let s = "";
                            ...
                            return ('"' !== e[e.length - 1] || 1 === e.length) && t(e.length, "MISSING_CHAR", 'Missing closing "quote'), s
                        }(l, c);
                        break;
                    default:
                        return s(e, "UNEXPECTED_TOKEN", `Expected a flow scalar value, but found: ${o}`), {
                            value: "",
                            type: null,
                            comment: "",
            ...
            function tO(e) {
                ...
                let i = n[1],
                    r = " ",
                    o = t.lastIndex;
                for (s.lastIndex = o; n = s.exec(e);) "" === n[1] ? "\n" === r ? i += r : r = "\n" : (i += r + n[1], r = " "), o = s.lastIndex;
                let l = /[ \t]*(.*)/sy;
            ...
            function tT(e, t, s, n) {
                ...
                let {
                    ...
                    comment: l,
                    range: a
                } = "block-scalar" === t.type ? tE(t, e.options.strict, n) : tN(t, e.options.strict, n), c = s ? e.directives.tagName(s.source, e => n(s, "TAG_RESOLVE_FAILED", e)) : null, f = s && c ? function(e, t, s, n, i) {
                    if ("!" === s) return e[u];
                    let r = [];
                    for (let t of e.tags)
                    ...
                    return o && !o.collection ? (e.tags.push(Object.assign({}, o, {
                        default: !1,
                        test: void 0
                    })), o) : (i(n, "TAG_RESOLVE_FAILED", `Unresolved tag: ${s}`, "tag:yaml.org,2002:str" !== s), e[u])
                }(e.schema, r, c, s, n) : "scalar" === t.type ? function({
                    directives: e,
                    schema: t
                }, s, n, i) {
                    let r = t.tags.find(e => e.default && e.test ? .test(s)) || t[u];
                    if (t.compat) {
                        let o = t.compat.find(e => e.default && e.test ? .test(s)) ? ? t[u];
                        if (r.tag !== o.tag) {
                ...
                try {
                    let o = f.resolve(r, e => n(s ? ? t, "TAG_RESOLVE_FAILED", e), e.options);
                    i = g(o) ? o : new F(o)
                } catch (o) {
                    let e = o instanceof Error ? o.message : String(o);
                    n(s ? ? t, "TAG_RESOLVE_FAILED", e), i = new F(r)
                }
                return i.range = a, i.source = r, o && (i.type = o), c && (i.tag = c), f.format && (i.format = f.format), l && (i.comment = l), i
            }
            let tI = {
                composeNode: tL,
                composeEmptyNode: tx
            ...
            function tL(e, t, s, n) {
                ...
                switch (t.type) {
                    case "alias":
                        ...
                        }(e, t, n), (l || a) && n(t, "ALIAS_PROPS", "An alias node must not specify any properties");
                        break;
                    case "scalar":
                    case "single-quoted-scalar":
                    case "double-quoted-scalar":
                    ...
                    case "flow-collection":
                        i = function(e, t, s, n, i) {
                            let r = n ? t.directives.tagName(n.source, e => i(n, "TAG_RESOLVE_FAILED", e)) : null,
                                o = "block-map" === s.type ? "map" : "block-seq" === s.type ? "seq" : "{" === s.start.source ? "map" : "seq";
                            if (!n || !r || "!" === r || r === eE.tagName && "map" === o || r === eO.tagName && "seq" === o || !o) return tS(e, t, s, i, r);
                            let l = t.schema.tags.find(e => e.tag === r && e.collection === o);
                            if (!l) {
                                let a = t.schema.knownTags[r];
                                if (!a || a.collection !== o) return a ? .collection ? i(n, "BAD_COLLECTION_TYPE", `${a.tag} used for ${o} collection, but expects ${a.collection}`, !0) : i(n, "TAG_RESOLVE_FAILED", `Unresolved tag: ${r}`, !0), tS(e, t, s, i, r);
                                t.schema.tags.push(Object.assign({}, a, {
                                    default: !1
                                })), l = a
                            }
                            let a = tS(e, t, s, i, r, l),
                                c = l.resolve ? .(a, e => i(n, "TAG_RESOLVE_FAILED", e), t.options) ? ? a,
                                u = w(c) ? c : new F(c);
                            return u.range = a.range, u.tag = r, l ? .format && (u.format = l.format), u
                        }(tI, e, t, a, n), l && (i.anchor = l.source.substring(1));
                        break;
                    default:
                        {
                            let r = "error" === t.type ? t.message : `Unsupported token (type: ${t.type})`;n(t, "UNEXPECTED_TOKEN", r),
                            i = tx(e, t.offset, void 0, null, s, n),
                            c = !1
                        }
                }
                return l && "" === i.anchor && n(l, "BAD_ALIAS", "Anchor cannot be an empty string"), r && (i.spaceBefore = !0), o && ("scalar" === t.type && "" === t.source ? i.comment = o : i.commentBefore = o), e.options.keepSourceTokens && c && (i.srcToken = t), i
            }
            ...
            class t_ {
                constructor(e = {}) {
                    this.doc = null, this.atDirectives = !1, this.prelude = [], this.errors = [], this.warnings = [], this.onError = (e, t, s, n) => {
                        let i = t$(e);
                        n ? this.warnings.push(new th(i, t, s)) : this.errors.push(new tf(i, t, s))
                    }, this.directives = new B({
                        ...
                        case "document":
                            {
                                let t = function(e, t, {
                                    ...
                                    u.found && (a.directives.docStart = !0, i && ("block-map" === i.type || "block-seq" === i.type) && !u.hasNewline && o(u.end, "MISSING_CHAR", "Block collection cannot start on same line with directives-end marker")), a.contents = i ? tL(c, i, u, o) : tx(c, u.end, n, null, u, o);
                                    let f = a.contents.range[2],
                                        h = tk(r, f, !1, o);
                                    return h.comment && (a.comment = h.comment), a.range = [s, f, h.offset], a
                        ...
                        case "error":
                            {
                                let t = e.source ? `${e.message}: ${JSON.stringify(e.source)}` : e.message,
                                    s = new tf(t$(e), "UNEXPECTED_TOKEN", t);this.atDirectives || !this.doc ? this.errors.push(s) : this.doc.errors.push(s);
                                break
                            }
                        case "doc-end":
                            {
                                if (!this.doc) {
                                    this.errors.push(new tf(t$(e), "UNEXPECTED_TOKEN", "Unexpected doc-end without preceding document"));
                                    break
                                }
                                this.doc.directives.docEnd = !0;
                                let t = tk(e.end, e.offset + e.source.length, this.doc.options.strict, this.onError);
...
${t.comment}` : t.comment
                        ...
                        default:
                            this.errors.push(new tf(t$(e), "UNEXPECTED_TOKEN", `Unsupported token ${e.type}`))
                    }
                }* end(e = !1, t = -1) {
            ...
            function tj(e, t, s = {}) {
                let {
                    ...
                    inFlow: r = !1,
                    type: o
                } = s, l = "indent" in e ? e.indent : null;
                if (n && "number" == typeof l && (l += 2), !o) switch (e.type) {
                    case "single-quoted-scalar":
                        o = "QUOTE_SINGLE";
                        break;
                    case "double-quoted-scalar":
                    ...
                    case ">":
                        ! function(e, t) {
                            ...
                            if ("block-scalar" === e.type) {
                                ...
                                let {
                                    offset: t
                                } = e, s = "indent" in e ? e.indent : -1, r = [{
                                    type: "block-scalar-header",
                                    offset: t,
                                    indent: s,
                                    source: n
                                }];
                                for (let t of (tD(r, "end" in e ? e.end : void 0) || r.push({
                                        type: "newline",
                                        offset: -1,
                                        indent: s,
                                        source: "\n"
                    ...
                    case "block-scalar":
                        {
                            let n = e.props.slice(1),
                                i = t.length;
                            for (let t of ("block-scalar-header" === e.props[0].type && (i -= e.props[0].source.length), n)) t.offset += i;delete e.props,
                            Object.assign(e, {
                                type: s,
                                source: t,
                                end: n
            ...
            tJ.BREAK = tR, tJ.SKIP = tF, tJ.REMOVE = tV, tJ.itemAtPath = (e, t) => {
                let s = e;
                for (let [e, n] of t) {
                    let t = s ? .[e];
            ...
            let tY = "\uFEFF",
                ...
                tQ = "\x1f",
                tH = e => !!e && "items" in e,
                tX = e => !!e && ("scalar" === e.type || "single-quoted-scalar" === e.type || "double-quoted-scalar" === e.type || "block-scalar" === e.type);
            ...
            let t1 = "0123456789ABCDEFabcdef".split(""),
                t2 = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()".split(""),
                t9 = ",[]{}".split(""),
                t8 = " ,[]{}\n\r	".split(""),
            ...
            class t6 {
                ...
                continueScalar(e) {
                    ...
                    if ("-" === t || "." === t) {
                        ...
                        if (("---" === t || "..." === t) && t0(this.buffer[e + 3])) return -1
                    }
                    return e
                }
                getLine() {
                ...
                peek(e) {
                    ...
                    if (e[0] === tY && (yield* this.pushCount(1), e = e.substring(1)), "%" === e[0]) {
                        let t = e.length,
                            s = e.indexOf("#");
                        if (-1 !== s) {
                            let n = e[s - 1];
                    ...
                    if ("-" === e || "." === e) {
                        ...
                        let e = this.peek(3);
                        if ("---" === e && t0(this.charAt(3))) return yield* this.pushCount(3), this.indentValue = 0, this.indentNext = 0, "doc";
                        if ("..." === e && t0(this.charAt(3))) return yield* this.pushCount(3), "stream"
                    }
                    return this.indentValue = yield* this.pushSpaces(!1), this.indentNext > this.indentValue && !t0(this.charAt(1)) && (this.indentNext = this.indentValue), yield* this.parseBlockStart()
                }* parseBlockStart() {
                    let [e, t] = this.peek(2);
                    ...
                    let e, t;
                    let s = -1;
                    do(e = yield* this.pushNewline()) > 0 ? (t = yield* this.pushSpaces(!1), this.indentValue = s = t) : t = 0, t += yield* this.pushSpaces(!0); while (e + t > 0);
                    let n = this.getLine();
                    if (null === n) return this.setNext("flow");
                    if (-1 !== s && s < this.indentNext && "#" !== n[0] || 0 === s && (n.startsWith("---") || n.startsWith("...")) && t0(n[3])) {
                        let e = s === this.indentNext - 1 && 1 === this.flowLevel && ("]" === n[0] || "}" === n[0]);
                        if (!e) return this.flowLevel = 0, yield tG, yield* this.parseLineStart()
                    }
                    let i = 0;
                    for (;
                        "," === n[i];) i += (yield* this.pushCount(1)) + (yield* this.pushSpaces(!0)), this.flowKey = !1;
                    switch (n[i += yield* this.pushIndicators()]) {
                        ...
                        case ":":
                            {
                                let e = this.charAt(1);
                                if (this.flowKey || t0(e) || "," === e) return this.flowKey = !1, yield* this.pushCount(1), yield* this.pushSpaces(!0), "flow"
                            }
                        default:
                    ...
                    let e, t = this.pos - 1,
                        s = 0;
                    e: for (let n = this.pos; e = this.buffer[n]; ++n) switch (e) {
                        case " ":
                            s += 1;
                            break;
                        case "\n":
                    ...
                    if (s >= this.indentNext) {
                        -1 === this.blockScalarIndent ? this.indentNext = s : this.indentNext += this.blockScalarIndent;
                        do {
                    ...
                    return yield tQ, yield* this.pushToIndex(t + 1, !0), yield* this.parseLineStart()
                }* parsePlainScalar() {
                    let e;
                    ...
                    for (; e = this.buffer[++n];)
                        ...
                        if ("\r" === e && ("\n" === i ? (n += 1, e = "\n", i = this.buffer[n + 1]) : s = n), "#" === i || t && t9.includes(i)) break;
                        if ("\n" === e) {
                            let e = this.continueScalar(n + 1);
                            if (-1 === e) break;
                            n = Math.max(n, e - 2)
                    ...
                    return e || this.atEnd ? (yield tQ, yield* this.pushToIndex(s + 1, !0), t ? "flow" : "doc") : this.setNext("plain-scalar")
                }* pushCount(e) {
                    ...
                    switch (this.charAt(0)) {
                        ...
                        case "&":
                            return (yield* this.pushUntil(t4)) + (yield* this.pushSpaces(!0)) + (yield* this.pushIndicators());
                        case "-":
                        case "?":
                        case ":":
                            {
                                let e = this.flowLevel > 0,
                                    t = this.charAt(1);
                                if (t0(t) || e && t9.includes(t)) return e ? this.flowKey && (this.flowKey = !1) : this.indentNext = this.indentValue + 1, (yield* this.pushCount(1)) + (yield* this.pushSpaces(!0)) + (yield* this.pushIndicators())
                            }
                    }
                    return 0
                }* pushTag() {
                    if ("<" === this.charAt(1)) {
                        ...
                        for (; t;)
                            ...
                            else if ("%" === t && t1.includes(this.buffer[e + 1]) && t1.includes(this.buffer[e + 2])) t = this.buffer[e += 3];
                        else break;
                    ...
                    let t, s = this.pos - 1;
                    do t = this.buffer[++s]; while (" " === t || e && "	" === t);
                    let n = s - this.pos;
            ...
            function sn(e) {
                if ("flow-seq-start" === e.start.type)
                    for (let t of e.items) !t.sep || t.value || t7(t.start, "explicit-key-ind") || t7(t.sep, "map-value-ind") || (t.key && (t.value = t.key), delete t.key, se(t.value) ? t.value.end ? Array.prototype.push.apply(t.value.end, t.sep) : t.value.end = t.sep : Array.prototype.push.apply(t.start, t.sep), delete t.sep)
            }
            class si {
                constructor(e) {
                    this.atNewLine = !0, this.atScalar = !1, this.indent = 0, this.offset = 0, this.onKeyLine = !1, this.stack = [], this.source = "", this.type = "", this.lexer = new t6, this.onNewLine = e
                }* parse(e, t = !1) {
                    for (let s of (this.onNewLine && 0 === this.offset && this.onNewLine(0), this.lexer.lex(e, t))) yield* this.next(s);
                    t || (yield* this.end())
                }* next(e) {
                ...
                peek(e) {
                    ...
                    if (t) {
                        if (0 === this.stack.length) yield t;
                            ...
                            let e = this.peek(1);
                            switch ("block-scalar" === t.type ? t.indent = "indent" in e ? e.indent : 0 : "flow-collection" === t.type && "document" === e.type && (t.indent = 0), "flow-collection" === t.type && sn(t), e.type) {
                                case "document":
                                    e.value = t;
                                    break;
                                case "block-scalar":
                                ...
                                case "block-seq":
                                    {
                                        let s = e.items[e.items.length - 1];s.value ? e.items.push({
                                            start: [],
                                            value: t
                                        }) : s.value = t;
                                        break
                                ...
                                case "flow-collection":
                                    {
                                        let s = e.items[e.items.length - 1];!s || s.value ? e.items.push({
                                            start: [],
                                            key: t,
                                            sep: []
                                        }) : s.sep ? s.value = t : Object.assign(s, {
                                            key: t,
                                            sep: []
                                        });
                                        return
                            ...
                            if (("document" === e.type || "block-map" === e.type || "block-seq" === e.type) && ("block-map" === t.type || "block-seq" === t.type)) {
                                ...
                                s && !s.sep && !s.value && s.start.length > 0 && -1 === t5(s.start) && (0 === t.indent || s.start.every(e => "comment" !== e.type || e.indent < t.indent)) && ("document" === e.type ? e.end = s.start : e.items.push({
                                    start: s.start
                                }), t.items.splice(-1, 1))
                            }
                        }
                    ...
                    switch (this.type) {
                        case "doc-start":
                            -1 !== t5(e.start) ? (yield* this.pop(), yield* this.step()) : e.start.push(this.sourceToken);
                            return;
                        case "anchor":
                        case "tag":
                        case "space":
                    ...
                    switch (this.type) {
                        case "newline":
                            if (this.onKeyLine = !1, t.value) {
                                ...
                                n ? .type === "comment" ? s ? .push(this.sourceToken) : e.items.push({
                    ...
                    if (this.indent >= e.indent) {
                        ...
                        switch (this.type) {
                            case "anchor":
                            case "tag":
                                s || t.value ? (n.push(this.sourceToken), e.items.push({
                                    start: n
                                }), this.onKeyLine = !0) : t.sep ? t.sep.push(this.sourceToken) : t.start.push(this.sourceToken);
                                return;
                            case "explicit-key-ind":
                                t.sep || t7(t.start, "explicit-key-ind") ? s || t.value ? (n.push(this.sourceToken), e.items.push({
                                    start: n
                                })) : this.stack.push({
                                    type: "block-map",
                                    offset: this.offset,
                            ...
                            case "map-value-ind":
                                ...
                                } else t.sep ? t.value || s ? e.items.push({
                                    start: n,
                                    key: null,
                                    sep: [this.sourceToken]
                            ...
                            case "double-quoted-scalar":
                                {
                                    let i = this.flowScalar(this.type);s || t.value ? (e.items.push({
                                        start: n,
                                        key: i,
                                        sep: []
                            ...
                            default:
                                {
                                    ...
                                    if (i) {
                                        s && "block-seq" !== i.type && t7(t.start, "explicit-key-ind") && e.items.push({
                                            start: n
                                        }), this.stack.push(i);
                                        return
                                    }
                    ...
                    if ("flow-error-end" === this.type) {
                        ...
                        switch (this.type) {
                            ...
                            case "double-quoted-scalar":
                                {
                                    let s = this.flowScalar(this.type);!t || t.value ? e.items.push({
                                        start: [],
                                        key: s,
                                        sep: []
                                    }) : t.sep ? this.stack.push(s) : Object.assign(t, {
                                        key: s,
                                        sep: []
                                    });
                                    return
            ...
            function so(e, t = {}) {
                let {
                    lineCounter: s,
                    prettyErrors: n
                } = sr(t), i = new si(s ? .addNewLine), r = new t_(t), o = Array.from(r.compose(i.parse(e)));
                if (n && s)
                    for (let t of o) t.errors.forEach(td(e, s)), t.warnings.forEach(td(e, s));
            ...
            function sl(e, t = {}) {
                let {
                    lineCounter: s,
                    prettyErrors: n
                } = sr(t), i = new si(s ? .addNewLine), r = new t_(t), o = null;
                for (let t of r.compose(i.parse(e), !0, e.length))
                    if (o) {
                        if ("silent" !== o.options.logLevel) {
                            o.errors.push(new tf(t.range.slice(0, 2), "MULTIPLE_DOCS", "Source contains multiple documents; please use YAML.parseAllDocuments()"));
                            break
                        }
                    } else o = t;
                return n && s && (o.errors.forEach(td(e, s)), o.warnings.forEach(td(e, s))), o
            }
            ...
            function sa(e, t, s) {
                ...
                let i = sl(e, s);
                if (!i) return null;
                if (i.warnings.forEach(e => eh(i.options.logLevel, e)), i.errors.length > 0) {
            ...
            function sc(e, t, s) {
                let n = null;
                if ("function" == typeof t || Array.isArray(t) ? n = t : void 0 === s && t && (s = t), "string" == typeof s && (s = s.length), "number" == typeof s) {
                    let e = Math.round(s);
                    s = e < 1 ? void 0 : e > 8 ? {
                        indent: 8
                    } : {
