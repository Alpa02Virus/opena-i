! function() {
    ...
    b.m = u, b.amdO = {}, e = [], b.O = function(t, n, r, c) {
        ...
        for (var a = 1 / 0, f = 0; f < e.length; f++) {
            for (var n = e[f][0], r = e[f][1], c = e[f][2], o = !0, d = 0; d < n.length; d++) a >= c && Object.keys(b.O).every(function(e) {
                return b.O[e](n[d])
            }) ? n.splice(d--, 1) : (o = !1, c < a && (a = c));
            if (o) {
                e.splice(f--, 1);
                var u = r();
                void 0 !== u && (t = u)
        ...
        return 8682 === e ? "static/chunks/sso-4422ed8ed4c2a68b.js" : 1703 === e ? "static/chunks/1703-8ad56a87215fb336.js" : 5608 === e ? "static/chunks/5608-759824b790b19522.js" : "static/chunks/" + (5823 === e ? "30750f44" : e) + "." + ({
    ...
    }, b.p = "https://cdn.oaistatic.com/_next/", a = {
        2272: 0
    }, b.f.j = function(e, t) {
        ...
        for (e && e(t); d < c.length; d++) r = c[d], b.o(a, r) && a[r] && a[r][0](), a[r] = 0;
        return b.O(u)
