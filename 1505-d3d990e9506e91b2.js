                ...
                let t = e + "CollectionProvider",
                    ...
                    a = e => {
                        let {
                            scope: t,
                            children: r
                        } = e, u = n.useRef(null), o = n.useRef(new Map).current;
                    ...
                    d = n.forwardRef((e, t) => {
                        let {
                            scope: r,
                            children: u
                        } = e, i = f(s, r), c = (0, o.e)(t, i.collectionRef);
                        return n.createElement(l.g7, {
                            ref: c
                        }, u)
                    }),
                    ...
                    m = n.forwardRef((e, t) => {
                        let {
                            ...
                            children: u,
                            ...i
                        } = e, c = n.useRef(null), a = (0, o.e)(t, c), s = f(v, r);
                        return n.useEffect(() => (s.itemMap.set(c, {
                            ref: c,
                            ...i
                        }), () => void s.itemMap.delete(c))), n.createElement(l.g7, {
                            [p]: "",
                            ref: a
                        }, u)
                    });
                    ...
                    let r = f(e + "CollectionConsumer", t),
                        u = n.useCallback(() => {
                            ...
                            let t = Array.from(e.querySelectorAll(`[${p}]`)),
                                ...
                                u = n.sort((e, r) => t.indexOf(e.ref.current) - t.indexOf(r.ref.current));
                            return u
                ...
                return u.scopeName = e, [function(t, u) {
                    ...
                    function i(t) {
                        let {
                            ...
                            children: u,
                            ...i
                        } = t, c = (null == r ? void 0 : r[e][l]) || o, f = (0, n.useMemo)(() => i, Object.values(i));
                        return (0, n.createElement)(c.Provider, {
                            value: f
                        }, u)
                    }
                    return r = [...r, u], i.displayName = t + "Provider", [i, function(r, i) {
        ...
        21381: function(e, t, r) {
            ...
            function o({
                ...
                let [o, l] = function({
                    ...
                    defaultProp: t,
                    onChange: r
                }), i = void 0 !== e, c = (0, u.W)(r), f = (0, n.useCallback)(t => {
                    if (i) {
