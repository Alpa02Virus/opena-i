    ...
    [9109], {
            ...
            function x(e) {
                var n = e.buttonText,
                    ...
                    g = (0, o.useCallback)(function(e) {
                        e.stopPropagation(), t(), m(!0), setTimeout(function() {
                            x() && m(!1)
                        }, 2e3)
                    }, [x, t]);
                return (0, i.jsxs)(i.Fragment, {
                    children: [!d && (0, i.jsxs)(p, {
                        onClick: g,
                        className: s,
                        children: [(0, i.jsx)(c.j4u, {
                            className: "icon-sm"
                        }), n]
                    }), d && (0, i.jsxs)(p, {
                        className: s,
                        children: [(0, i.jsx)(c.UgA, {
                            className: "icon-sm"
        ...
        48759: function(e, n, t) {
            ...
            function f(e) {
                ...
                return d ? (f = "Errors in ".concat(n), h = (0, i.jsx)(c.q5L, {
                    className: "icon-sm text-red-500"
                })) : u && (f = "Warnings in ".concat(n), h = (0, i.jsx)(c.bcx, {
        ...
        85330: function(e, n, t) {
            ...
            function m(e) {
                ...
                return (null == n ? void 0 : n.id) != null && (null == n ? void 0 : n.structure) == a.CZ.WORKSPACE ? "".concat(f, "/").concat(n.id) : f
            }

            function h(e) {
                var n = Array.from(new Set(i.m.getItem(m(e))));
                return {
                    enabledPluginIds: new Set(n.splice(0, u))
                }
            }
            ...
            function g(e) {
                e.length > u || x.setState(function() {
                    return i.m.setItem(m(s.ec.getState()), e), {
            ...
            function v(e) {
                x.setState(function(n) {
                    ...
                    return i.m.setItem(m(s.ec.getState()), t), {
        ...
        56817: function(e, n, t) {
            ...
            var r = "https://help.openai.com/en/collections/3943089-billing",
                ...
                s = "https://help.openai.com/en/articles/8258076-how-to-cancel-my-plus-subscription-in-the-chatgpt-android-app",
                i = {
                    WEBAPP: "chatgpt_web",
                ...
                o = {
                    ALREADY_PAID: "User is already paid"
                }
        },
        52481: function(e, n, t) {
            ...
            function I(e) {
                ...
                return (0, i.jsxs)(i.Fragment, {
                    children: [r.length > 0 && (0, i.jsxs)(g.z, {
                        className: "absolute left-2 top-2",
                        color: "neutral",
                        onClick: function() {
                            m(r[r.length - 1]), s(function(e) {
                                return e.slice(0, -1)
                            })
                        },
                        children: [(0, i.jsx)(f.lV_, {}), "Go back to ", r[r.length - 1]]
                    }), (0, i.jsx)("div", {
                        className: "flex flex-col items-center gap-4 overflow-auto p-4 text-xs",
                        children: u.map(function(e, t) {
                            var r = e.messages[0].nodeId,
                                a = o.tQ.getTree(n),
                                s = 0 !== t ? a.getParent(r) : null,
                                c = null != s ? s.children.findIndex(function(e) {
                                    return r === e
                                }) : 0,
                                u = null != s ? s.children : [],
                                d = u.slice(0, c),
                            ...
                            return (0, i.jsxs)("div", {
                                ...
                                children: [(0, i.jsx)("div", {
                                    className: "absolute bottom-0 left-0 -ml-2 flex -translate-x-full gap-2 pl-2",
                                    ...
                                    className: "absolute left-full top-0 ml-2 flex gap-2 pr-2",
                                    ...
                                    children: e.messages.map(function(e) {
                                        return (0, i.jsxs)("div", {
                                            className: "h-14 w-32 truncate bg-gray-200 p-1 text-black",
                                            children: [(0, i.jsx)("div", {
            ...
            function P(e) {
                ...
                return (0, i.jsx)("button", {
                    className: "w-32 truncate bg-gray-400 p-2 text-black opacity-50 hover:opacity-100",
                    onClick: function() {
                        t(n)
                    },
            ...
            function S() {
                var e = (0, s._)(["overflow-y-auto h-full md:w-[250px] lg:w-[300px] xl:w-[350px] 2xl:w-[400px] md:border-l md:border-gray-100 md:dark:border-gray-700 bg-white dark:bg-gray-900"]);
                return S = function() {
                    return e
                }, e
            }
            ...
            function O() {
                var e = (0, s._)(["px-6 py-4 flex flex-col gap-1 hover:bg-gray-50 dark:hover:bg-gray-500/10 cursor-pointer border-b dark:border-white/10 border-gray-200"]);
                return O = function() {
                    return e
                }, e
            }
                        ...
                        children: [(0, i.jsxs)("div", {
                            ...
                            children: [(0, i.jsxs)("div", {
                                ...
                                children: (0, i.jsxs)("button", {
                                    ...
                                    children: [(0, i.jsx)("span", {
                                        className: "sr-only",
                                        children: (0, i.jsx)(m.Z, (0, r._)({}, z.closeSidebar))
                                    }), (0, i.jsx)(f.q5L, {
                                        className: "icon-md",
                                        "aria-hidden": "true"
                                    })]
                    ...
                    r = n.map(function(e, n) {
                        ...
                        return (0, i.jsxs)(V, {
                            ...
                            children: [(0, i.jsxs)("div", {
                                ...
                                children: [a, s && s !== a && " (".concat(s, ")"), " -> ", (0, l.Ej)(e), (0, i.jsx)("div", {
            ...
            function R(e) {
                ...
                return w.has("debug") ? (0, i.jsxs)(A, {
                    ...
                    onClose: s,
                    children: [(0, i.jsx)("div", {
                        className: "mb-2 flex items-center justify-around px-4 py-1 text-xs font-medium uppercase",
                        children: (0, i.jsx)(U, {
                            clientThreadId: n,
                            messages: x
                        })
                        ...
                        children: [(0, i.jsx)("div", {
                            ...
                            children: [(0, i.jsx)(f.PMT, {
                                className: "icon-sm rotate-90"
                            }), "View tree"]
                        })]
                    }), (0, i.jsx)(E, {}), (0, i.jsx)(Z, {
                        messages: x,
                        setDebugMessageIndex: v
                    }), void 0 !== g && (0, i.jsx)(j.Z, {
                        isOpen: !0,
                        onClose: N,
                        type: "success",
                    ...
                    }, "DebugMessageModal-".concat(g)), k && (0, i.jsx)(j.Z, {
                        isOpen: !0,
                        onClose: function() {
                            return C(!1)
                        },
            ...
            function D(e, n) {
                var t = JSON.stringify({
                        conversation_id: o.tQ.getServerThreadId(e),
                        messages: n
                    }, null, 2),
                    r = new Blob([t], {
                ...
                s.href = a, s.download = "messages-".concat(o.tQ.getServerThreadId(e), ".json"), s.click(), URL.revokeObjectURL(a)
            }
        ...
        87389: function(e, n, t) {
            ...
            function f() {
                var e, n, t = (0, l.useRouter)(),
                    f = (0, o.kP)().session,
                    m = (null == f ? void 0 : null === (e = f.user) || void 0 === e ? void 0 : e.idp) === "auth0",
                    h = !!(null == f ? void 0 : null === (n = f.user) || void 0 === n ? void 0 : n.mfa),
                    x = (0, s._)((0, u.useState)(!1), 2),
                    p = x[0],
                    g = x[1],
                    v = (0, u.useCallback)((0, r._)(function() {
                        var e;
                        return (0, i.Jh)(this, function(n) {
                            if (e = new URL(t.asPath, window.location.origin).toString(), !m) throw Error("Only username/password users can enable MFA");
                            ...
                            return (0, c.signIn)(f.authProvider, {
                                callbackUrl: e
                            }, (0, a._)({
                                prompt: "login"
                    ...
                    b = (0, u.useCallback)((0, r._)(function() {
                        var e;
                        return (0, i.Jh)(this, function(n) {
                            switch (n.label) {
                                case 0:
                                    if (!m) throw Error("Only username/password users can disable MFA");
                                    if (!f) throw Error("No session found, cannot enable MFA");
                                    if ("mocked" === f.authProvider) throw Error("Mock users can't enable MFA! Please setup Auth0 following the instructions in the README");
                                    return g(!0), [4, d.ZP.deleteMfa()];
                                case 1:
                                    return n.sent(), [4, (0, c.signOut)({
                                        redirect: !1,
